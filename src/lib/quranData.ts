...
export const RECITERS: Reciter[] = [
  ...
  { id: 24, name: 'محمد رفعت (مجود)', server: 'https://surahquran.com/mp3/Rifat', fallbackServer: 'https://server14.mp3quran.net/refat' },
  { id: 25, name: 'شعبان الصياد (مجود)', server: 'https://surahquran.com/mp3/shaban', fallbackServer: 'https://server11.mp3quran.net/shaban' },
  { id: 26, name: 'محمد عبدالوهاب الطنطاوي (مجود)', server: 'https://surahquran.com/mp3/Tantawy', fallbackServer: 'https://server10.mp3quran.net/tantawi' },
